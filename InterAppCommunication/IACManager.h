...
typedef void(^IACActionHandlerBlock)(NSDictionary *_Nullable  inputParameters, _Nullable IACSuccessBlock success, _Nullable IACFailureBlock failure);

@interface IACManager : NSObject

// Delegate to be called when an x-callback-url API call is made for this app 
@property (weak, nonatomic, nullable) id<IACDelegate> delegate;
...
@property (copy, nonatomic, nullable) NSString *callbackURLScheme;
